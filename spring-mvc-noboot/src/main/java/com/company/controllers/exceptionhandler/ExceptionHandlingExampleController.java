...
public class ExceptionHandlingExampleController {
    ...
    @ResponseBody
    public String handleRequest3(HttpServletRequest request) throws UserNotLoggedInException {
    ...
    public String exceptionHandler3(UserNotLoggedInException ex, Model model) {
